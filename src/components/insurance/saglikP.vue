<template>
      ...
      <h4 class="text-center">SAĞLIK SİGORTASI TEKLİFİ AL</h4>
      <div class="hline"></div>
      <div class="offer-intro">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <p
                class="text-err"
                v-for="error of v$.userData.vno.$errors"
                :key="error.$uid"
              >
                {{ error.$message }}
              </p>
          ...
          <div class="row mt-3 mb-3">
            <div class="col-md-6">
              <div class="row">
                <label class="form-label col-12">Poliçe Tipi*</label>
                <div class="col-md-6">
                  <div class="form-check">
                    <input
                      ...
                      name="poliçe"
                      id="ferdi"
                      v-model="userData.p_tipi"
                   
                    :class="
                    v$.userData.p_tipi.$error === true
                    ? 'input-err'
                    : ' '
                      "
                    />
                    <label class="form-check-label" for="ferdi">
                      Ferdi Poliçe
                    </label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-check">
                    ...
                    : ' '
                      "
                    />
                    <label class="form-check-label" for="aile">
                      Aile Poliçe
                    </label>
                  </div>
                </div>
              ...
              <p
                class="text-err"
                v-for="error of v$.userData.p_tipi.$errors"
                :key="error.$uid"
              >
                {{ error.$message }}
              </p>
            ...
            <div class="col-md-6">
              <div class="row">
                <label class="form-label col-12">Cinsiyet*</label>
                <div class="col-md-6">
                  <div class="form-check">
                    <input
                      class="form-check-input mt-2"
                      ...
                      :class="
                  v$.userData.cinsiyet.$error === true
                    ? 'input-err'
                    : ''
                     "
                    />
              ...
              <p
                class="text-err"
                v-for="error of v$.userData.cinsiyet.$errors"
                :key="error.$uid"
              >
                {{ error.$message }}
              </p>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                <label for="dogumtarih" class="form-label"
                  >Doğum Tarihiniz</label
                >
                <input type="date" class="form-control" id="dogumtarih" />
              </div>
            </div>
          </div>
          <div class="row">
...
<!-- poliçe ve cinsiyet seçerken ilk tıklamada olmuyo -->
<script>
