<template>
  <div class="col-md-10 mx-auto">
    <h4 class="text-center">KASKO TEKLİFİ AL</h4>
    <div class="hline"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            ">
              ...
              <option v-for="arac in getaraclar" :key="arac" :value="arac.araclar_id">{{ arac.araclar_name }}</option>
            </select>
          ...
          <div class="col-md-6 mb-3">
            ...
            ">
              ...
              <option v-for="model in onChange" :key="model" :value="model.model_id">{{ model.model_name }}</option>
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="defaultCheck1">
            Bu form ile "Trafik Sigortası Teklifi" de almak istiyorum
          </label>
        </div>
...
export default {
  ...
  methods: {
    onSave() {
      ...
      console.log("_onchange sonucu:",this.onChange)
    console.log("_getaraclar sonucu:",this.getaraclar)
    console.log("yazdir sonucu:",this.yazdir)
    },
  },
  computed:{
    ...mapGetters({
      getaraclar:"_getaraclar",
      onChange:"_onChange",
      yazdir:"_yazdir"
    })
  },
